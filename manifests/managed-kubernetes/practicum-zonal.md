...
--folder-id $FOLDER \
--name cam-kuber-practicum \
--description "YC praktikum model_gitops" \
--labels cam=practicum \
--network-id $NETWORK \
--zone $ZONE \
--subnet-id $SUBNET \
--public-ip \
...
--folder-id $FOLDER \
--name cam-fixed-practicum \
--cluster-name cam-kuber-practicum \
--description "fixed-practicum-deploy-infrastructure" \
